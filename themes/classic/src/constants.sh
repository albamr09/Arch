...
BASIC_PACKAGES="$LIGHTDM_PACKAGES $GPU_PACKAGES $TWM $TERMINAL rofi imagemagick nitrogen zsh gpicview scrot dunst git wget vim neovim nano unzip"
UTILITIES_PACKAGES="xdg-utils acpi alsa-utils python-psutil"
PROGRAM_PACKAGES="qutebrowser zathura zathura-pdf-poppler"
DEVELOPMENT_SOFTWARE_PACKAGES="python312 python-pip nodejs npm yarn"
