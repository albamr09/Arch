...
sudo chown -R $USUARIO /home/$USUARIO/.??* && chmod -R 665 /home/$USUARIO/.??* &> /dev/zero && mensaje_exito "Se han cambiado los permisos para $USUARIO" || mensaje_fallo "Fallo durante el cambio de permisos en $USUARIO"
sudo chown -R $USUARIO /home/$USUARIO/* && chmod -R 665 /home/$USUARIO/??* &> /dev/zero && mensaje_exito "Se han cambiado los permisos para $USUARIO" || mensaje_fallo "Fallo durante el cambio de permisos en $USUARIO"
